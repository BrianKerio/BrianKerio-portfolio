    ...
    >
      ...
      <div className="w-full lgl:w-1/2">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="overflow-x-hidden">
            <p className="text-sm uppercase font-medium">Java & XML</p>
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                initial={{ x: "-100%", opacity: 0 }}
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[73%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
              >
                <span className="absolute -top-7 right-0">73%</span>
              </motion.span>
            </span>
          </div>
          <div className="overflow-x-hidden">
          ...
          <div className="overflow-x-hidden">
            ...
            <span className="w-full h-2 bgOpacity rounded-md inline-flex mt-2">
              <motion.span
                ...
                animate={{ x: 0, opacity: 1 }}
                transition={{ duration: 0.5, delay: 0.5 }}
                className="w-[25%] h-full bg-gradient-to-r from-blue-600 via-pink-500 to-red-500 rounded-md relative"
              >
